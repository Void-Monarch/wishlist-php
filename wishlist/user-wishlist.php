...
<input type="button" href="#" onclick="history.back();" class="btn form-btn-submit btn-popup" value="&#8592 Back">
        ...
        <nav class="navigation_nav">
            <ul class="navigation_list">
                ...
                <li class="navigation_item"><a href="<?php if(!isset($_SESSION['uname'])){ echo "../login/Login_frontend.php#login-here"; } else{echo "#";} ?>" class="navigation_link-nav"><span class="navigation-icon icofont-library">&nbsp;</span>Wishlist</a></li>
...
<section class="tile">
    ...
    <div class="row">
        <?php include "../php/user-tile.php"; ?>
    </div>

</section>


<?php include '../php/user-popup.php'; ?>
</body>
</html>