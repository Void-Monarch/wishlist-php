...
$flag=0;
$icon='plus';
$li="../wishlist/wishlist-user.php?c_id=".$c_id."&c_name_pop=".$c_name_pop;
...
foreach($arr_c_id as $value){
    ...
    if($c_id==$value){
        ...
        $li="../wishlist/user-remove.php?c_id=".$c_id."&c_name_pop=".$c_name_pop;
    }
}
    ...
    echo '<form>
    <div class="popup" id="user-popup_'.$c_name_pop.'">
        <div class="popup_content">
            ...
            <div class="popup_right">
                <a href="#user-tile_'.$c_name_pop.'" class="popup_close icofont-close">&nbsp</a>
